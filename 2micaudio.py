...
def main():
	...
	for i in range(200):
		...
		data1 = mic1.data
		data2 = mic2.data
		print("Mic1 -> avg : "+str(mic1.avg)+" max : "+str(mic1.max)+" min: "+str(mic1.min)+"\n")
		print("Mic2 -> avg : "+str(mic2.avg)+" max : "+str(mic2.max)+" min: "+str(mic2.min)+"\n")
		#data3 = mic3.data
		...
		# wave 2 offset
		a1 = a.findDifference()  # if lower number, then wave 1 is closer to sound
		#b1 = b.findDifference()
		#c1 = c.findDifference()
		
		# wave 1 offset
		ar1 = ar.findDifference() # if lower number, then wave 2 is closer to sound
		#br1 = br.findDifference()
		#cr1 = cr.findDifference()
		
		determineDirection(ar1, a1, 1, 2)
